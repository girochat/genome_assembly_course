...
# Output
my_output <- paste("analysis/evaluation/busco/short_summaries_all/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('canu_assembly_polished', 'canu_assembly_polished', 'canu_assembly_polished', 'canu_assembly_polished', 'flye_assembly_polished', 'flye_assembly_polished', 'flye_assembly_polished', 'flye_assembly_polished', 'trinity_assembly', 'trinity_assembly', 'trinity_assembly', 'trinity_assembly', 'canu_assembly', 'canu_assembly', 'canu_assembly', 'canu_assembly', 'flye_assembly', 'flye_assembly', 'flye_assembly', 'flye_assembly')
...
my_percentage <- c(97.4, 1.2, 0.1, 1.3, 97.7, 1.1, 0.1, 1.1, 46.0, 26.5, 4.9, 22.6, 95.7, 1.6, 0.6, 2.1, 96.9, 1.1, 0.4, 1.6)
my_values <- c(4478, 55, 6, 57, 4490, 49, 6, 51, 2112, 1217, 226, 1041, 4399, 74, 29, 94, 4452, 52, 18, 74)
